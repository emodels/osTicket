    ...
    <div id="header">
        ...
        <p id="info">Welcome, <strong><?php echo $thisstaff->getFirstName(); ?></strong>
           <?php
            ...
            | <a href="<?php echo ROOT_PATH ?>scp/admin.php">Admin Panel</a>
            <?php }else{ ?>
            | <a href="<?php echo ROOT_PATH ?>scp/index.php">Staff Panel</a>
            <?php } ?>
            | <a href="<?php echo ROOT_PATH ?>scp/profile.php">My Preferences</a>
            | <a href="<?php echo ROOT_PATH ?>scp/logout.php?auth=<?php echo $ost->getLinkToken(); ?>">Log Out</a>
        </p>
    </div>
    <ul id="nav">
        <?php
